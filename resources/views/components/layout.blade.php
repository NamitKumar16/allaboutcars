...
<section class="px-6 py-8">
    <nav class="md:flex md:justify-between md:items-center">
        <div>
            <a href="/">
                <img src="https://di-uploads-pod23.dealerinspire.com/rollsroycemotorcarspasadena/uploads/2019/08/2019-Rolls-Royce-Phantom-hub.png" alt="Laracasts Logo" width="165" height="16">
            </a>
        </div>
    ...
    <footer id="newsletter"
        ...
        <img src="/images/newsletter.png" alt="" class="mx-auto" style="width: 250px;">
